<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Admin.Master" AutoEventWireup="true" CodeBehind="details_donation_form.aspx.cs" Inherits="FYP_DFB.details_donation_form" %>
                        ...
                        <asp:UpdatePanel ID="role_UpdatePanel" runat="server">
                            <ContentTemplate>
                                <table>
                                    ...
                                    <tr>
                                        <td style="white-space: nowrap;">
                                            <asp:Label runat="server" Text="Donate As: " Font-Bold="True" Width="130px"></asp:Label>
                                        </td>
                                        <td>
                        ...
                        <table style="margin-left: -2.5rem;">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox ID="DonateDate" runat="server" type="date" Height="30px" Width="130px" Visible="False"></asp:TextBox>
                                </td>
                            </tr>
                            <tr><td></td></tr>
                            <tr><td></td></tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <br />
                                    <asp:Label runat="server" Text="*Applicable only for donations weighing more than 15 kgs." style="color:#9e9e9e; font-size: 0.8rem;" ></asp:Label>
                                </td>
                            </tr>
                        </table>
                        <br /><br />
                        <asp:Label ID="donation_role" runat="server" Text="member role" Visible="false"></asp:Label>
                        <asp:Label ID="verified" runat="server" Text="verified" Visible="false"></asp:Label>
                        <asp:Button ID="confirmButton" runat="server" Text="Confirm Pick Up" ForeColor="#FA65B1" BorderColor="#FA65B1" CssClass="asp-submit-button" OnClick="confirmButton_Click" width="300px" style="margin-left: 15rem;"/>
                        <br /><br />
                        <asp:Button ID="completeButton" runat="server" Text="Complete Donation" ForeColor="#FA65B1" BorderColor="#FA65B1" CssClass="asp-submit-button" OnClick="completeButton_Click" width="300px" style="margin-left: 15rem;"/>
                        <br /><br />
                        <asp:Button ID="closeButton" runat="server" Text="Close Donation" ForeColor="#FA65B1" BorderColor="#FA65B1" CssClass="asp-submit-button" OnClick="closeButton_Click" width="300px" style="margin-left: 15rem;"/>
                    </div>
                </div>
            </div>
        </div> 
