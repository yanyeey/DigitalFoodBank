<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Admin.Master" AutoEventWireup="true" CodeBehind="details_assistance_form.aspx.cs" Inherits="FYP_DFB.details_assistance_form" %>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="section-heading">
                                            <h4>Manage Assistance Request</h4>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3  wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.2s">
                    <div class="section-heading">
                        <h4><em>Assistance Request Details</em></h4>
                ...
                <div class="row wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">   
                    <div class="col-lg-6 offset-lg-3">
                            ...
                            <ContentTemplate>
                                <table>
                                    ...
                                    <tr>
                                        <td style="width: 350px;">
                                            <asp:Label runat="server" Text="Request As: " Font-Bold="True"></asp:Label>
                                        </td>
                                        <td>
                                ...
                                <div id="individualFields" runat="server">
                                    <table>
                                        ...
                                        <tr>
                                            <td style="width: 350px;">
                                                <asp:Label runat="server" Text="Last Name:" Font-Bold="True" Width="130px"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td style="width: 350px; white-space: nowrap;">
                                                <asp:Label runat="server" Text="Identification Number:" Font-Bold="True" Width="130px"></asp:Label>
                                            </td>
                                            <td>
                        ...
                        <table style="margin-left: -2.5rem;">
                            <tr>
                                <td style="width: 350px; white-space: nowrap;">
                                    <asp:Label runat="server" Text="Date to Receive: " Font-Bold="True"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="DisplayDate" runat="server" Height="30px" Width="130px" ></asp:TextBox>
                                    <asp:TextBox ID="ReceiveDate" type="date" runat="server" Height="30px" Width="130px" ></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>
                                    <asp:RequiredFieldValidator ID="Validator_ReceiveDate" runat="server" ErrorMessage="*Please Enter Date." ControlToValidate="ReceiveDate" Display="Dynamic" Text="*Please Enter Date." EnableClientScript="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr><td></td></tr>
                            <tr><td></td></tr>
                            <tr>
                                <td style="width: 350px; white-space: nowrap;">
                                    <asp:Label runat="server" Text="Expected Receival Time: " Font-Bold="True"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ReceiveTime_DropDownList" runat="server" Height="30px" Width="180px">
                            ...
                            <tr>
                                <td></td>
                                <td>
                                    <asp:RequiredFieldValidator ID="Validator_Time" runat="server" ErrorMessage="*Please Enter Time." ControlToValidate="ReceiveTime_DropDownList" Display="Dynamic" Text="*Please Enter Time." EnableClientScript="True" ForeColor="Red"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr><td></td></tr>
                            <tr><td></td></tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <br />
                                    <asp:Label runat="server" Text="*Applicable only for verified recipients." style="color:#9e9e9e; font-size: 0.8rem;" Width= "230px"></asp:Label>
                                </td>
                            </tr>
                        </table>
                        <br /><br />
                        <asp:Label ID="assistance_role" runat="server" Text="member role" Visible="false"></asp:Label>
                        <asp:Label ID="verified" runat="server" Text="verified" Visible="false"></asp:Label>
                        <asp:Label ID="Error_Message" runat="server" Text="error" Visible="false" style="margin-left: 15rem;"></asp:Label>
                        <asp:Button ID="assignButton" runat="server" Text="Assign Date and Time" ForeColor="#FA65B1" BorderColor="#FA65B1" CssClass="asp-submit-button" OnClick="assignButton_Click" width="300px" style="margin-left: 15rem;"/>
                        <br /><br />
                        <asp:Button ID="completeButton" runat="server" Text="Complete Request" ForeColor="#FA65B1" BorderColor="#FA65B1" CssClass="asp-submit-button" OnClick="completeButton_Click" width="300px" style="margin-left: 15rem;"/>
                        <br /><br />
                        <asp:Button ID="closeButton" runat="server" Text="Close Request" ForeColor="#FA65B1" BorderColor="#FA65B1" CssClass="asp-submit-button" OnClick="closeButton_Click" width="300px" style="margin-left: 15rem;"/>
                    </div>
                </div>
            </div>
        </div> 
