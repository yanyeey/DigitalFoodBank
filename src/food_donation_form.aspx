<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="food_donation_form.aspx.cs" Inherits="FYP_DFB.FoodDonationForm" %>
                    ...
                    <div class="col-lg-6 offset-lg-3">
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="contact_no" runat="server" Height="50px" Width="350px" Placeholder=" Contact Number"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                        ...
                        <table style="margin-left: -2.5rem;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="DonateDate" runat="server" type="date" Height="30px" Width="130px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
