<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="manage_donation_member.aspx.cs" Inherits="FYP_DFB.member_donation" %>
                    ...
                    <div class="col-lg-6 offset-lg-3">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" RowStyle-Height="75px" style="margin-left: -17rem;" BorderStyle="Solid" BorderColor="#fa65b1" BorderWidth="2px">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Donation Time" DataField="donation_time" HeaderStyle-Height="50" ItemStyle-CssClass="gridview-item" HeaderStyle-Wrap="False" DataFormatString="{0:d}">
                                    <HeaderStyle CssClass="header-style" ForeColor="#fa65b1" />
                                </asp:BoundField>
