<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Admin.Master" AutoEventWireup="true" CodeBehind="details_member.aspx.cs" Inherits="FYP_DFB.details_member" %>
                ...
                <div class="row wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">   
                    <div class="col-lg-6 offset-lg-3" style="margin-left: 25rem;">
                        ...
                        <table>
                            ...
                            <tr>
                                <td style="width: 350px;">
                                    <asp:Label runat="server" Text="Verification Status: " Font-Bold="True"></asp:Label>
                                </td>
                                <td style="width: 350px;">
                                    <asp:Label runat="server" ID="verified" Text="State"></asp:Label>                      
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                        ...
                        <br /><br />
                        <asp:Button ID="submit_button" runat="server" Text="Verify Member" ForeColor="#FA65B1" Height="50px" Width="350px" BorderColor="#FA65B1" CssClass="asp-submit-button" Style="margin-left: 5rem;" OnClick="submit_button_Click" />
                        ...
                        <asp:Label ID="member_role" runat="server" Text="member role" Visible="false"></asp:Label>
                        <br /><br /><br />
                    </div>
                </div>
            </div>
