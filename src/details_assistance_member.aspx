<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="details_assistance_member.aspx.cs" Inherits="FYP_DFB.details_assistance_member" %>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="section-heading">
                                            <h4>Assistance Request Details</h4>
                   ...
                   <div class="col-lg-6 offset-lg-3">
                        ...
                        <table style="margin-left: -2.5rem;">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="ReceiveDate" runat="server" Height="30px" Width="130px" ></asp:TextBox>
                                </td>
                            </tr>
                            <tr><td></td></tr>
                            <tr><td></td></tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <br />
                                    <asp:Label runat="server" Text="*Applicable only for verified recipients." style="color:#9e9e9e; font-size: 0.8rem;" Width="350px"></asp:Label>
                                </td>
                            </tr>
                        </table>
                        <br /><br />
                        ...
                        <asp:Label ID="delivery_text" runat="server" Text="delivery" Visible="false"></asp:Label>
                        <asp:Button ID="cancelButton" runat="server" Text="Cancel Request" ForeColor="#FA65B1" BorderColor="#FA65B1" CssClass="asp-submit-button" OnClick="cancelButton_Click" style="width: 250px; margin-left: 18rem;"/>
                    </div>
                </div>
            </div>
        </div> 
