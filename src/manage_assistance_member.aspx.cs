...
namespace FYP_DFB
{
    public partial class manage_assistance_member : System.Web.UI.Page
    {
        ...
        private void BindGridViewData()
        {
            ...
            SqlDataAdapter da1 = new SqlDataAdapter("SELECT assistance_id, assistance_date, assistance_time, assistance_delivery_service, assistance_status FROM ASSISTANCE_FORM where assistance_member_id = '" + Session["member_id"].ToString() + "'", dbconnection1);
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "ViewDetails")
            {
                ...
                Response.Redirect("details_assistance_member.aspx?assistanceID=" + assistanceID + "&memberID=" + memberID);
            }
        }
